...
public class OracleTransaction : IDbTransaction
{
    ...
    {
        EnsureActive();
        Console.WriteLine("  [Oracle] Transaction committed.");
        _isActive = false;
    }
    ...
    {
        EnsureActive();
        Console.WriteLine("  [Oracle] Transaction rolled back.");
        _isActive = false;
    }
    ...
    public void Dispose()
    {
        if (_isActive)
        {
            Console.WriteLine("  [Oracle] Transaction disposed without commit — auto-rollback.");
            _isActive = false;
        }
    }
